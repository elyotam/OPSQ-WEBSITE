...
const he = {
  ...
  demo: {
    window: "משימה חדשה",
    live: "מבצע",
    user: "תבדוק אם משה שלח את החוזה. אם כן, תסכם לי מה הוא כתב ותקבע לנו פגישה למחר.",
    steps: [
  ...
  flow: {
    ...
    request: "״תטפל בפגישה עם משה״",
    steps: [
      { label: "מבין את המטרה", tool: "" },
      { label: "מחפש את משה", tool: "contacts.search" },
      ...
      { label: "שולח עדכון למשה", tool: "gmail.send" },
...
const en: Dictionary = {
  ...
  demo: {
    window: "New task",
    live: "Working",
    user: "Check whether Moshe sent the contract. If he did, summarize what he wrote and book us a meeting for tomorrow.",
    steps: [
  ...
  flow: {
    ...
    request: "“Handle the meeting with Moshe”",
    steps: [
      { label: "Understands the goal", tool: "" },
      { label: "Looks up Moshe", tool: "contacts.search" },
      ...
      { label: "Emails Moshe an update", tool: "gmail.send" },
